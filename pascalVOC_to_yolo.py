...
if _name_ == "_main_":
    ...
    parser.add_argument("voc_dir", help="Path to PascalVOC annotations directory")
    parser.add_argument("yolo_dir", help="Path to output YOLO format directory")
    parser.add_argument("classes_file", help="Path to class mapping file")
